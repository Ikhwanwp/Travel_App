...
Color mainColor = "407BFF".toColor();
Color greyColor1 = "727272".toColor();
Color greyColor2 = "C0C0C0".toColor();
...
TextStyle greyFontStyle2 = GoogleFonts.poppins()
    .copyWith(color: greyColor1, fontWeight: FontWeight.w300, fontSize: 12);
